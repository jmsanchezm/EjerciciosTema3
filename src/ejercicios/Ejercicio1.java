...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		//Una vez haya salido del bucle, debido a que el usuario introdujera un número negativo, se le mostrará lo siguiente en pantalla.
		System.out.print("El resultado de la suma de los números enteros es: " + suma);
